    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          {/* Create New Map Popover */}
          <Popover open={showCreateForm} onOpenChange={setShowCreateForm} className='w-full flex-1'>
            ...
            <PopoverContent className="max-w-[400px]" align="start">
              <MapConfigCreateForm
